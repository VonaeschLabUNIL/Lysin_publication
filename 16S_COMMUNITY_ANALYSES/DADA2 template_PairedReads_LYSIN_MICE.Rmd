...
setwd("/Users/julian/Documents/1A_POST_DOC_LAUSANNE_2022/14_ALINE_MASTER/1A_MOUSE_EXPERIMENTS/NOVOGEN_16S/R_ANALYSIS/SEQUENCES")

# Save path to fastq file folder after unzipping
path <- "/Users/julian/Documents/1A_POST_DOC_LAUSANNE_2022/14_ALINE_MASTER/1A_MOUSE_EXPERIMENTS/NOVOGEN_16S/R_ANALYSIS/SEQUENCES"
# Control files
list.files(path)
```
...
write.table(seqtab, "seqtab.txt", sep="\t", quote=F, row.names=T, col.names=T)
